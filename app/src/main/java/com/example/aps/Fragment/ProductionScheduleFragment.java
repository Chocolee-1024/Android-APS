...
import com.example.aps.Activity.TableQueryAcivity;
import com.example.aps.Activity.SettingActivity;
import com.example.aps.databinding.FragmentProductionScheduleBinding;
...
public class ProductionScheduleFragment extends Fragment {
     ...
     * @return A new instance of fragment production_schedule.
     */
    ...
    private void init(){
        //換頁至Setting
        binding.settingbut.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //換頁至TableQuery
        binding.inquirebt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), TableQueryAcivity.class);
                startActivity(intent);
            }
        });
    }
